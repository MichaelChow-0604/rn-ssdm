...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        "relative web:group flex flex-row w-full web:cursor-default web:select-none items-center rounded-sm py-1.5 native:py-2 pl-8 native:pl-10 pr-2 web:hover:bg-accent/50 active:bg-foreground web:outline-none web:focus:bg-accent",
    ...
    >
      ...
      <SelectPrimitive.ItemText className="text-sm native:text-lg text-black native:text-base web:group-focus:text-accent-foreground" />
    </SelectPrimitive.Item>
  );
}
