...
function TableRow({
  ...
  return (
    <TablePrimitive.Row
      className={cn(
        "flex-row border-gray-200 border-b web:transition-colors web:hover:bg-muted/50 web:data-[state=selected]:bg-muted mx-1",
        className
      )}
      {...props}
    />
...
function TableCell({
  ...
  return (
    <TablePrimitive.Cell
      className={cn(
        "align-middle [&:has([role=checkbox])]:pr-0 py-4",
        className
      )}
      {...props}
    />
